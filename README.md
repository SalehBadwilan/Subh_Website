...
> منصة تجارة إلكترونية مدعومة بالذكاء الاصطناعي متعددة التجار (ويب + Android + iOS)
...
| الدور          | المسؤول |
| -------------- | ------- |
| قائد الفريق    | صالح بادويلان       |
| Frontend       | اياد قدح      |
| Backend        | روان الشاطري      |
| QA & Security  | أماسي الصحبي      |
| DevOps & Cloud | عزام عبدالله     |
