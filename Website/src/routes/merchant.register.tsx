...
const approvedApplication = apps?.find(
  (app) => app.status === "approved"
);

const rejectedApplication = apps?.find(
          ...
          {plans.length > 0 && (
            <section className="rounded-2xl border border-border bg-card p-6">
              ...
              <p className="mt-3 flex items-start gap-1.5 text-[11px] leading-relaxed text-muted-foreground">
               ...
               بعد قبول طلبك، سيتم تفعيل حساب التاجر، ويمكنك اختيار الباقة المناسبة والاشتراك من لوحة التاجر.
              </p>
            </section>
          )}
        </div>
