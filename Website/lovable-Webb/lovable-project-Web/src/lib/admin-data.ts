...
export const seedCatalog: CatalogProduct[] = [
  {
    ...
    description: "سمّاعات بلوتوث بخاصية عزل الضوضاء النشط وبطارية تدوم ٣٠ ساعة.",
  ...
  },
  {
    ...
    description: "ساعة ذكية لتتبع النشاط ومعدل النبض والنوم.",
    categoryId: "electronics",
    price: 599,
    sku: "SUBH-EL-1002",
    stock: 85,
  ...
  },
  {
    ...
    description: "قهوة عربية محمّصة حديثًا بنكهة الهيل.",
    categoryId: "grocery",
    price: 65,
    sku: "SUBH-GR-2001",
    stock: 300,
  ...
  },
  {
    ...
    description: "مبخرة كهربائية بتصميم فاخر وتحكم بالحرارة.",
    categoryId: "home",
    price: 220,
    sku: "SUBH-HM-3001",
    stock: 60,
  ...
  },
  {
    ...
    description: "طقم من ٦ كاسات شاي زجاجية بتصميم أنيق.",
    categoryId: "home",
    price: 95,
    sku: "SUBH-HM-3002",
    stock: 150,
  ...
  },
  {
    ...
    description: "خلاط بقوة ٨٠٠ واط لعصائر وسموذي.",
    categoryId: "home",
    price: 199,
    sku: "SUBH-HM-3003",
    stock: 45,
  ...
  },
  {
    ...
    description: "شمعة برائحة العود الفاخرة تدوم حتى ٤٠ ساعة.",
    categoryId: "home",
    price: 75,
    sku: "SUBH-HM-3004",
    stock: 200,
  ...
  },
  {
    ...
    description: "زجاجة تحافظ على الحرارة حتى ١٢ ساعة.",
    categoryId: "sports",
    price: 89,
    sku: "SUBH-SP-4001",
    stock: 180,
  ...
  },
  {
    ...
    description: "عباءة سوداء بتطريز يدوي.",
    categoryId: "fashion",
    price: 289,
    sku: "SUBH-FS-5001",
    stock: 40,
  ...
  },
  {
    ...
    description: "حقيبة ظهر جلدية بجودة عالية للعمل والسفر.",
    categoryId: "fashion",
    price: 179,
    sku: "SUBH-FS-5002",
    stock: 70,
...
export const seedPackages: AdminPackage[] = [
  ...
  },
  {
    ...
    features: ["حتى ٢٠٠ منتج", "تقارير مبيعات متقدمة", "تسويات أسبوعية", "حتى ٥ موظفين"],
    active: true,
    featured: true,
  },
  {
    ...
    features: ["منتجات غير محدودة", "تسويات يومية", "موظفون غير محدودون", "مدير حساب مخصّص"],
    active: true,
  },
];
...
export const seedRoles: AdminRole[] = [
  ...
  },
  {
    ...
    permissions: ["إدارة الطلبات", "إدارة التجّار", "إدارة المنتجات", "إدارة الفئات"],
  },
  {
    id: "support",
    name: "خدمة العملاء",
