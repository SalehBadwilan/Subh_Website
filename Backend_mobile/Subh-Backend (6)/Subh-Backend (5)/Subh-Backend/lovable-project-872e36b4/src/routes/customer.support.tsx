  ...
  return (
    <PageContainer>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <ContactCard icon={<Phone className="h-5 w-5" />} label="اتصل بنا" value="+966 92000 0000" href="tel:+966920000000" />
        <ContactCard icon={<Mail className="h-5 w-5" />} label="البريد" value="care@subh.sa" href="mailto:care@subh.sa" />
        <ContactCard icon={<MessageCircle className="h-5 w-5" />} label="واتساب" value="+966 55 000 0000" href="https://wa.me/966550000000" />
      </div>
