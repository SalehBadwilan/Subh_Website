...
export const categories: Category[] = [
  { id: "fashion", name: "أزياء", icon: Shirt, tone: "bg-rose-50 text-rose-600", description: "ملابس رجالية ونسائية وأطفال" },
  { id: "electronics", name: "إلكترونيات", icon: Smartphone, tone: "bg-sky-50 text-sky-600", description: "هواتف، حواسيب، وإكسسوارات" },
  { id: "home", name: "منزل وأثاث", icon: Sofa, tone: "bg-amber-50 text-amber-600", description: "أثاث وديكور وأدوات منزلية" },
  { id: "beauty", name: "جمال وعناية", icon: Sparkles, tone: "bg-fuchsia-50 text-fuchsia-600", description: "عطور، مكياج، والعناية الشخصية" },
  { id: "grocery", name: "بقالة", icon: Utensils, tone: "bg-emerald-50 text-emerald-600", description: "أطعمة ومشروبات ومنتجات يومية" },
  { id: "kids", name: "أطفال", icon: Baby, tone: "bg-orange-50 text-orange-600", description: "ألعاب ومستلزمات الأطفال" },
  { id: "sports", name: "رياضة", icon: Dumbbell, tone: "bg-lime-50 text-lime-700", description: "معدات ولياقة ورياضات مختلفة" },
  { id: "books", name: "كتب", icon: BookOpen, tone: "bg-indigo-50 text-indigo-600", description: "كتب أدبية وعلمية ودينية" },
];
